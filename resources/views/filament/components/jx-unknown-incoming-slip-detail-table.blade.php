    ...
    <table class="w-full border-collapse border border-gray-300 text-sm dark:border-gray-600">
        <thead>
            <tr class="bg-gray-50 dark:bg-gray-800">
                ...
                <th class="border border-gray-300 px-2 py-1 text-center font-semibold text-gray-900 dark:border-gray-600 dark:text-gray-100">先方商品CD</th>
                ...
                <th class="border border-gray-300 px-2 py-1 text-right font-semibold text-gray-900 dark:border-gray-600 dark:text-gray-100">単価</th>
                <th class="border border-gray-300 px-2 py-1 text-right font-semibold text-gray-900 dark:border-gray-600 dark:text-gray-100">金額</th>
        ...
        <tbody>
            @forelse ($details as $detail)
                @php
                    $isMissing = $detail['match_status'] === '該当なし';
                    $rowClass = $isMissing ? 'bg-red-50 dark:bg-red-900/20' : 'bg-white dark:bg-gray-900';
                    $statusClass = $isMissing ? 'text-red-700 dark:text-red-300 font-semibold' : 'text-yellow-700 dark:text-yellow-300 font-semibold';
                @endphp
                <tr class="{{ $rowClass }}">
                    ...
                    <td class="border border-gray-300 px-2 py-1 text-center text-gray-700 dark:border-gray-600 dark:text-gray-300">{{ $detail['item_code'] }}</td>
                    ...
                    <td class="max-w-[240px] truncate border border-gray-300 px-2 py-1 text-gray-700 dark:border-gray-600 dark:text-gray-300">{{ $detail['product_name'] }}</td>
                    ...
                    <td class="border border-gray-300 px-2 py-1 text-right text-gray-700 dark:border-gray-600 dark:text-gray-300">{{ $detail['unit_price'] }}</td>
                    <td class="border border-gray-300 px-2 py-1 text-right text-gray-700 dark:border-gray-600 dark:text-gray-300">{{ $detail['amount'] }}</td>
                    <td class="border border-gray-300 px-2 py-1 text-center dark:border-gray-600 {{ $statusClass }}">{{ $detail['match_status'] }} {{ $detail['is_shortage'] }}</td>
                </tr>
            @empty
                <tr>

                    ...
                    <template x-for="(row, index) in rows" :key="row.warehouse_id + '-' + row.item_code + '-' + row.contractor_id + '-' + index">
                        <tr
                            :class="isEosUnavailable(row)
                                ...
                                : (index % 2 === 0 ? 'bg-white dark:bg-slate-900' : 'bg-blue-50/70 dark:bg-slate-800/80')"
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap px-2 py-1.5 text-slate-700 dark:text-slate-200">
                                ...
                                <span x-show="channelControlled && row.is_eos_available === false" class="inline-flex rounded bg-amber-100 px-1.5 py-0.5 text-[10px] font-bold text-amber-800 dark:bg-amber-900/40 dark:text-amber-200">EOS不可</span>

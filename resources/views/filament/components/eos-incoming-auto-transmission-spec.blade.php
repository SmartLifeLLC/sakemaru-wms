<div class="space-y-5">
    ...
    <div class="grid gap-4 lg:grid-cols-2">
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            ...
            <ul class="mt-3 space-y-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li>「今すぐ実行」は定期実行と同じ処理をQueueに投入します。</li>
            </ul>
        </section>
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            ...
            <ol class="mt-3 list-decimal space-y-2 pl-5 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li>最後に、発注系は設定日数経過後に欠品完了し、店間移動は予定日を1日以上過ぎている未完了入荷予定を全て完了にします。</li>
            </ol>
        </section>
    </div>
    ...
    <div class="grid gap-4 lg:grid-cols-2">
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            <h3 class="text-sm font-semibold text-gray-950 dark:text-white">欠品完了と移動入荷予定</h3>
            <ul class="mt-3 space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <li>発注系の未完了入荷予定は、設定された欠品完了日数を過ぎると欠品完了します。初期値は14日です。</li>
                <li>この欠品完了はEOS送信済みに限定せず、対象日の未完了入荷予定全体に対して実行します。</li>
    ...
    <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <div class="mt-3 grid gap-4 lg:grid-cols-3">
            ...
            <div>
                ...
                <ul class="mt-2 space-y-1.5 text-sm text-gray-700 dark:text-gray-300">
                    <li>実行単位で受信、取込、照合、適用、仕入生成、発注欠品完了、移動完了の件数を保存します。</li>

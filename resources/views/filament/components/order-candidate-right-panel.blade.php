<div>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="modal-info-card">
            <dt class="modal-label">倉庫不足</dt>
            <dd class="modal-value-large">{{ number_format($selfShortageQty) }}</dd>
        </div>

        <div class="modal-info-card">
            <dt class="modal-label">移動依頼</dt>
            <dd class="modal-value-large">{{ number_format($satelliteDemandQty) }}</dd>
        </div>

        <div class="modal-info-card">
            <dt class="modal-label">算出数</dt>
            <dd class="modal-value-primary">{{ number_format($suggestedQuantity) }}</dd>
        </div>
    </div>

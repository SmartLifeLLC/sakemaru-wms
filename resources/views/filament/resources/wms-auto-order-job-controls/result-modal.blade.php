    ...
    @if ($isSnapshot)
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">スナップショット件数</div>
            </div>
            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $record->started_at?->format('Y-m-d H:i:s') ?? '-' }}</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">開始日時</div>
            </div>
            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $record->finished_at?->format('Y-m-d H:i:s') ?? '-' }}</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">終了日時</div>
            </div>
        </div>

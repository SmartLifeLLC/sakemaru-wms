                            ...
                            @if($canChangeCourse)
                                <div class="flex items-end space-x-2">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center px-3 py-2 text-xs font-medium rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 whitespace-nowrap mb-1 shadow-sm"
                                    >
                                        変更
                                    </button>
                                </div>
